...
interface ModalProps {
  ...
  /** Rendered top-right of the header, opposite the close (X) button — e.g. an "Edit" toggle. */
...
export default function Modal({ open, onOpenChange, title, size = 'sm', hideVisualTitle, headerAction, footer, children }: ModalProps) {
  return (
